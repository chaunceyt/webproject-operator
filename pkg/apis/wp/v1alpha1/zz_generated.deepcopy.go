...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebProjectDockerConfig) DeepCopyInto(out *WebProjectDockerConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebProjectDockerConfig.
func (in *WebProjectDockerConfig) DeepCopy() *WebProjectDockerConfig {
	if in == nil {
		return nil
	}
	out := new(WebProjectDockerConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WebProjectSpec) DeepCopyInto(out *WebProjectSpec) {
	*out = *in
	out.Backup = in.Backup
	out.CLISidecar = in.CLISidecar
	out.CacheSidecar = in.CacheSidecar
	out.DatabaseSidecar = in.DatabaseSidecar
	...
	out.SearchSidecar = in.SearchSidecar
