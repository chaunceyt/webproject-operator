...
func (r *ReconcileWebproject) ensureSearchSidecarCronJobConfigMap(request reconcile.Request, instance *wp.WebProject, cm *corev1.ConfigMap) (*reconcile.Result, error) {
	found := &corev1.ConfigMap{}
...
func (r *ReconcileWebproject) ensureSearchContainerCronJob(request reconcile.Request, instance *wp.WebProject, cron *v1beta1.CronJob) (*reconcile.Result, error) {
	found := &v1beta1.CronJob{}
...
func (r *ReconcileWebproject) ensureDatabaseContainerCronJob(request reconcile.Request, instance *wp.WebProject, cron *v1beta1.CronJob) (*reconcile.Result, error) {
	found := &v1beta1.CronJob{}
...
func (r *ReconcileWebproject) ensureWebContainerCronJob(request reconcile.Request, instance *wp.WebProject, cron *v1beta1.CronJob) (*reconcile.Result, error) {
	found := &v1beta1.CronJob{}
